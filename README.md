...
[![测试](https://img.shields.io/badge/测试-333%20全部通过-brightgreen?style=flat-square)]()
...
```
333 个测试 · 0 失败 · 其中 64 项为安全/硬化/自审/终审回归 · 0 运行时依赖
```
...
| [`docs/PPT-NARRATION-ZH.md`](./docs/PPT-NARRATION-ZH.md) | **PPT 口播稿** — 逐页台词、实测 3:23、停顿标记 |
