...
| **Tests** | 333 — unit, gateway, sizing, 64 security/hardening/self-audit/final-gate regressions, real-process E2E |
...
Two independent adversarial reviews found **7 + 8 + 7 defects**; a further **7** were found by attacking
